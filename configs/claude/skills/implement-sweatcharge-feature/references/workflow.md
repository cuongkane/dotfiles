...
2. Invoke the worktree's `openspec-explore` skill (`.claude/skills/openspec-explore/SKILL.md`).
...
Invoke `openspec-propose` (`.claude/skills/openspec-propose/SKILL.md`) with the explored brief and
...
Invoke `openspec-sync-specs` (`.claude/skills/openspec-sync-specs/SKILL.md`) with the explicit
