...
```bash
cp ~/.codex/skills/create-latex-slides/templates/slide.tex <project-dir>/slide.tex
cp ~/.codex/skills/create-latex-slides/templates/UTU.sty  <project-dir>/UTU.sty
cp ~/.codex/skills/create-latex-slides/templates/.gitignore <project-dir>/.gitignore
...
```bash
python3 ~/.codex/skills/create-latex-slides/scripts/lighten_svg.py <project-dir>/fig/
```
...
```bash
~/.codex/skills/create-latex-slides/scripts/build.sh <project-dir>
```
...
```bash
~/.codex/skills/create-latex-slides/scripts/preflight.sh <project-dir>
```
