...
source "packages/codex/install_codex.sh"
source "packages/playwright/install_playwright.sh"
source "packages/browser-use/install_browser_use.sh"
source "packages/plannotator/install_plannotator.sh"
source "packages/aws/install_aws.sh"
source "packages/gcloud/install_gcloud.sh"
...
source "packages/ccstatusline/install_ccstatusline.sh"
